            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a class="nav-link" href="formularios/loginUsuario.html">Login</a></li>
                        <li class="nav-item"><a class="nav-link" href="formularios/altaUsuario.html">Registro</a></li>
                    </ul>
                </div>
            </div>
        </nav>
